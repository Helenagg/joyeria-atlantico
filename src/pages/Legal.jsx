  ...
  return (
    <div className='mt-32 mx-8'>
      ...
      <p className='mt-10 text-left text-secondary-green-dark'>
        ...
        Sociedad de la Información y del Comercio Electrónico (LSSICE), así como
        informar a todos los usuarios del sitio web respecto a cuáles son las
        condiciones de uso.
      </p>
      <p className='mt-10 text-left text-secondary-green-dark'>
      ...
      <p className='mt-10 text-left text-secondary-green-dark'>
        Joyería Atlántico, se reserva el derecho de modificar cualquier tipo de
        ...
        sitio web de Joyería Atlántico.
      </p>
      <h2 className='mt-10 text-xl text-primary font-bold'>
        1. DATOS IDENTIFICATIVOS:
      </h2>
      <ul className='mt-4 ml-4 text-left text-secondary-green-dark'>
        <li>– Denominación social: JOYERÍA ATLÁNTICO</li>
        <li>– Nombre comercial: Joyería Atlántico</li>
        <li>– CIF: BXXXXXXX</li>
      ...
      <p className='mt-4 text-left text-secondary-green-dark'>
        ...
        el Espacio Web y en especial, diseños, textos, imágenes, logos, iconos,
        botones, software, nombres comerciales, marcas, o cualesquiera otros
        signos susceptibles de utilización industrial y/o comercial están
      ...
      <p className='mt-4 text-left text-secondary-green-dark'>
        ...
        Condiciones Generales de Uso del Espacio Web no confieren a los Usuarios
        ningún otro derecho de utilización, alteración, explotación,
        reproducción, distribución o comunicación pública del Espacio Web y/o de
        ...
        la empresa o el tercero titular de los derechos afectados.
      </p>
      <p className='mt-4 text-left text-secondary-green-dark'>
        ...
        intelectual existente en este Espacio, así como el propio Espacio en su
        ...
        Espacio Web, lo menús, botones de navegación, el código HTML, los
        textos, imágenes, texturas, gráficos y cualquier otro contenido del
        Espacio Web o, en cualquier caso dispone de la correspondiente
        autorización para la utilización de dichos elementos. El contenido
        dispuesto en el Espacio Web no podrá ser reproducido ni en todo ni en
        parte, ni transmitido, ni registrado por ningún sistema de recuperación
        de información, en ninguna forma ni en ningún medio, a menos que se
        cuente con la autorización previa, por escrito, de la citada Entidad.
      </p>
      <p className='mt-4 text-left text-secondary-green-dark'>
        ...
        acciones legales le correspondan en defensa de sus legítimos derechos de
      ...
      <ul className='mt-4 ml-4 text-left text-secondary-green-dark'>
        <li>
          ...
          Espacio Web; (iii) la moral y buenas costumbres generalmente aceptadas
        ...
        <li>
          4. El Usuario será el único responsable de las manifestaciones falsas
        ...
        <li>
          ...
          <ul className='mt-4 ml-4 text-left text-secondary-green-dark'>
            <li>
              ...
              constitucionalmente, en los Tratados Internacionales y en el resto
              de la legislación vigente.
            </li>
            <li>
              • Induzca, incite o promueva actuaciones delictivas,
              denigratorias, difamatorias, violentas o, en general, contrarias a
              la ley, a la moral, a las buenas costumbres generalmente aceptadas
              o al orden público.
            </li>
            <li>
            ...
            <li>
              ...
              al orden público. Induzca o pueda inducir a un estado inaceptable
              de ansiedad o temor.
            </li>
            <li>
            ...
            <li>
              ...
              protección intelectual o industrial perteneciente a la sociedad o
              a terceros sin que haya sido autorizado el uso que se pretenda
              realizar.
            </li>
            <li>
            ...
            <li>
              • Constituya cualquier tipo de publicidad.• Incluya cualquier tipo
              de virus o programa que impida el normal funcionamiento del
              Espacio Web.
            </li>
          </ul>
        </li>
      ...
      <p className='mt-4 text-left text-secondary-green-dark'>
        ...
        indebido de su contraseña, como, a título enunciativo, su robo, extravío
        o el acceso no autorizado, con el fin de proceder a su inmediata
        cancelación. En consecuencia, mientras no efectúe la notificación
        anterior, la empresa quedará eximida de cualquier responsabilidad que
        ...
        servicios del Espacio Web por cualquier tercero ilegítimo. Si de manera
        negligente o dolosa incumpliera cualquiera de las obligaciones
      ...
      <p className='mt-4 text-left text-secondary-green-dark'>
        ...
        de cualquiera de los servicios ofertados en el mismo, es contrario a las
        presentes Condiciones Generales de Uso. No nos hacemos responsables por
        daños, perjuicios, pérdidas, reclamaciones o gastos derivados del uso
        del Espacio Web.
      </p>
      <p className='mt-4 text-left text-secondary-green-dark'>
      ...
      <ul className='mt-4 ml-4 text-left text-secondary-green-dark'>
        ...
        <li>
          ...
          del mismo. El administrador del espacio web se reserva el derecho de
          retirar, total o parcialmente, cualquier contenido o información
          presente en el Espacio Web.
        </li>
      </ul>
      <p className='mt-4 text-left text-secondary-green-dark'>
        La empresa excluye cualquier responsabilidad por los daños y perjuicios
        de toda naturaleza que pudieran deberse a la mala utilización de los
        servicios de libre disposición y uso por parte de los Usuarios de
        Espacio Web. Asimismo queda exonerado de cualquier responsabilidad por
        el contenido e informaciones que puedan ser recibidas como consecuencia
        de los formularios de recogida de datos, estando los mismos únicamente
        para la prestación de los servicios de consultas y dudas. Por otro lado,
        en caso de causar daños y perjuicios por un uso ilícito o incorrecto de
        dichos servicios, podrá ser el Usuario reclamado por los daños o
        perjuicios causados.
      </p>
      <p className='mt-4 text-left text-secondary-green-dark'>
        ...
        usted se obliga a indemnizar frente a cualesquiera daños y perjuicios,
        que se deriven del uso por su parte de “robots”, “spiders”, “crawlers” o
        herramientas similares empleadas con el fin de recabar o extraer datos o
        de cualquier otra actuación por su parte que imponga una carga
        irrazonable sobre el funcionamiento del Espacio Web.
      </p>
      <h2 className='mt-10 text-xl text-primary font-bold'>
        7. HIPERVÍNCULOS:
      </h2>
      <p className='mt-4 text-left text-secondary-green-dark'>
        ...
        mediante un hiperenlace o hipervínculo, el Espacio Web, así como ninguno
        de sus contenidos, salvo autorización expresa y por escrito del
      ...
      <p className='mt-4 text-left text-secondary-green-dark'>
        ...
        ello, la sociedad no se responsabiliza del contenido de dichos Espacios
        web, ni se sitúa en una posición de garante ni/o de parte ofertante de
        los servicios y/o información que se puedan ofrecer a terceros a través
        de los enlaces de terceros.
      </p>
      <p className='mt-4 text-left text-secondary-green-dark'>
        Se concede al Usuario un derecho limitado, revocable y no exclusivo a
        crear enlaces a la página principal del Espacio Web exclusivamente para
        uso privado y no comercial. Los Espacios web que incluyan enlace a
        nuestro Espacio Web (i) no podrán falsear su relación ni afirmar que se
        ha autorizado tal enlace, ni incluir marcas, denominaciones, nombres
        comerciales, logotipos u otros signos distintivos de nuestra sociedad;
        (ii) no podrán incluir contenidos que puedan considerarse de mal gusto,
        obscenos, ofensivos, controvertidos, que inciten a la violencia o la
        discriminación por razón de sexo, raza o religión, contrarios al orden
        público o ilícitos; (iii) no podrán enlazar a ninguna página del Espacio
        Web distinta de la página principal; (iv) deberá enlazar con la propia
        dirección del Espacio Web, sin permitir que el Espacio web que realice
        el enlace reproduzca el Espacio Web como parte de su web o dentro de uno
        de sus “frames” o crear un “browser” sobre cualquiera de las páginas del
        Espacio Web. La empresa podrá solicitar, en cualquier momento, que
        elimine cualquier enlace al Espacio Web, después de lo cual deberá
      ...
      <p className='mt-4 text-left text-secondary-green-dark'>
        ...
        previamente establecidas, en las condiciones definidas en la Política de
        Privacidad.
      </p>
      ...
      <p className='mt-4 text-left text-secondary-green-dark'>
        ...
        personalizar el uso que realice del Espacio Web mediante la preselección
        de su idioma, o contenidos más deseados o específico.
      </p>
      <p className='mt-4 text-left text-secondary-green-dark'>
      ...
      <p className='mt-4 text-left text-secondary-green-dark'>
        ...
        configurar su navegador para ser avisado en pantalla de la recepción de
        cookies y para impedir la instalación de cookies en su disco duro. Por
        favor consulte las instrucciones y manuales de su navegador para ampliar
        esta información.
      </p>
      <p className='mt-4 text-left text-secondary-green-dark'>
      ...
      <p className='mt-4 text-left text-secondary-green-dark'>
        ...
        no se otorga garantía ni declaración alguna en relación con los
        contenidos y servicios ofrecidos en el Espacio web, incluyendo, a título
      ...
      <p className='mt-4 text-left text-secondary-green-dark'>
        Las presentes Condiciones Generales de Uso, así como el uso del Espacio
        Web, se regirán por la legislación española. Para la resolución de
        cualquier controversia las partes se someterán a los Juzgados y
        Tribunales del domicilio social del Responsable del sitio web.
      </p>
      <p className='mt-4 text-left text-secondary-green-dark'>
        ...
        Condiciones Generales de Uso resulten no exigibles o nulas en su
        ...
        reflejados en la estipulación original.
      </p>
    </div>
  );
};
